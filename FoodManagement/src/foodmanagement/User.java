...
class User {
    ...
    private void select_hotel() {
        ...
        hotel_ch--;
        if (hotel_ch > Hotel.hotel_list.size()) {
            System.out.println("Invalid Input");
            select_hotel();
        }
        Hotel curr_hotel = Hotel.hotel_list.get(hotel_ch);
    ...
    public void printAllUser() {
        if (User.user_list.isEmpty()) {
            System.out.println("No user Available at the moment");
            return;
        }
        for (User user : User.user_list) {
